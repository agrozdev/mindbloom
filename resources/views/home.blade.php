              ...
              <div class="row justify-content-center">
                <div class="col-xxl-8">
                  ...
                  <div class="mad-text-medium content-element-6">
                    <p>Вярваме, че терапията работи най-добре като истинско партньорство. Съчетаваме доказани методи
                      от различни терапевтични школи с топъл, безоценъчен подход, така че винаги да се чувствате
                      чути.</p>
                    <p>От самата безплатна консултация се фокусираме върху практични стъпки, върху които можете да
                      продължите да работите между сесиите — не само върху разговор в рамките на час.</p>
                  </div>
