<div id="mad-nav-canvas" class="mad-nav-canvas full-screen">
  ...
  <a href="{{ route('home') }}" class="mad-logo"><img src="{{ asset('images/logo-mindbloom.png') }}" alt="MindBloom — терапия с приказки" /></a>
  ...
  <div class="mad-middle-header mad-header-section--sticky-xl">
    <div class="container-fluid">
      <div class="mad-header-items">
        ...
        <div class="mad-header-item">
          <a href="{{ route('home') }}" class="logo"><img src="{{ asset('images/logo-mindbloom.png') }}" alt="MindBloom — терапия с приказки" /></a>
        </div>
        <div class="mad-header-item">
          <div class="mad-actions">
            <div class="mad-col">
