...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $services = [
            ...
            [
                'slug' => 'uyrkshopi',
                'title' => 'Тишината, която променя',
                'excerpt' => 'Няколкодневни групови сесии извън Варна, сред природата — интензивна работа върху себе си в спокойна и подкрепяща среда.',
